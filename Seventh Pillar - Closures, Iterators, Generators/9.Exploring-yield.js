function* fetchNextElement() {
  ...
  const x = 10;
  console.log(yield 11); // * Printing yield
...
console.log("second", iter.next(55)); // entering after a yield, y = x + yield 30, here yield is a part of expression, yield keyword is extremely powerful, value of y is still undefined here as we will return and         print second 30
